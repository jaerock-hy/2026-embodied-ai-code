...
class Utility:
    ...
    # This method is computationally expensive and should be used for testing purposes only.
    # Note: 
    #   This method will not be used in the training process of neural networks, 
    #   as it is much slower than analytical gradients (backpropagation
